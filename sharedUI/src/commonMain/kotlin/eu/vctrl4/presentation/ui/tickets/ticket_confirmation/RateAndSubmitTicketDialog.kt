...
@Composable
fun RateAndSubmitTicketDialog(
	title: String?,
	dlgText: String?,
	submitBtnLabel: String,
	btnColorResId: Color,
	onDismiss: () -> Unit,
	onSubmit: (Pair<Int, String>) -> Unit
                             ) {
		...
		Surface(
			...
			Column(
				...
				Column(
					...
					Box(
						modifier = Modifier.height(48.dp).clip(shape = RoundedCornerShape(12.dp))
						.clickable {
							isPopupVisible.value = true
						}.background(btnColorResId), contentAlignment = Alignment.Center) {
						Text(
							text = submitBtnLabel,
					...
					if (isPopupVisible.value) {
						...
						SelfDismissingPopup(
							durationMillis = 2500,
							message = Res.string.your_decision_has_been_successfully_submitted.asState,
							onDismiss = {
...
fun RateAndSubmitTicketDialogPreview() {
	...
	RateAndSubmitTicketDialog(
		Res.string.sign_or_decline_completed_transportation.asState,
		"",
		Res.string.confirm_or_decline.asState,
		Colors.cl_e02020,
		{ },
		{})
}