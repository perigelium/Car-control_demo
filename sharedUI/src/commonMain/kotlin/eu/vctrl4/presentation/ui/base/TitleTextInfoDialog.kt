...
@Composable
fun TitleTextInfoDialog(dialogTitle: String,
                        strMsg: String,
                        btnLabel: String = Res.string.Ok.asState,
                        onDismiss: () -> Unit)
{
...
@Preview()
@Composable
fun TitleTextInfoDialogPreview()
{
    TitleTextInfoDialog(dialogTitle = "ConfirmCancel", strMsg = "MyText", Res.string.understand.asState,{})
}