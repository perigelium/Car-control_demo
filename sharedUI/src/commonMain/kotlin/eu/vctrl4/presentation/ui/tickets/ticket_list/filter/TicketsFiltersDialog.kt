...
fun TicketsFiltersDialog(
    companies: List<Company>, ordersRequest: OrderListRequest, onSubmit: (OrderListRequest) -> Unit, onDismiss: () -> Unit
)
{
    ...
    val selTicketState: IdNameSimple? = TICKET_STATES.firstOrNull { it.Id == remOrdersRequest.TicketState }
