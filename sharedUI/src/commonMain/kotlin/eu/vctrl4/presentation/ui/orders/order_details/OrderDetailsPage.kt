...
{
    Row(
        Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start, verticalAlignment = Alignment.CenterVertically
    ) {
...
fun OrderDetailsPreview()
{
    ...
    OrderDetailsPage(pageTitle = Res.string.additional_information_caps.asState, order = order, titleTexts = listOf(idName, idName1))
}